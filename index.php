...
<?php else: ?>
    ...
    <header class="hero">
        <div class="hero-content">
            ...
            <div class="hero-text">
                <h1>Chào mừng bé đến với thế giới Toán Lớp 1!</h1>
                <p>Học phép cộng , trừ , làm quen với một số hình phẳng hình khối đầy màu sắc. Học mà chơi, chơi mà học!</p>
    ...
    <div class="features-container">
        ...
        <div class="features-text">
            <h2 class="features-title">
                Học Toán Lớp 1 - <span class="highlight-text">Vui Hơn, Dễ Hơn!</span>
            </h2>
    ...
    <section class="courses-section">
        ...
        <div class="grid-container">
            ...
            <div class="card card-blue">
                ...
                <h3>Làm Quen các hình cơ bản </h3>
            ...
            <div class="card card-green">
                ...
                <p>Hình vuông , hình chữ nhật , hình tam giác.</p>
            </div>
