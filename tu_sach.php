   ...
   <header class="header-hoc10-wrapper">
        <div class="header-hoc10-container">
            <div class="header-left-section">
                <a href="index.php" class="brand-logo">
                    ...
                    <div style="display:none;" class="logo-text">HocToan<span>1</span></div>
                </a>
                <nav class="nav-menu">
    ...
    <div class="book-page-container">
        ...
        <div class="book-header-text">
            <h1>Tủ sách</h1>
            <p>Tủ sách là nơi chứa sách giáo khoa chuẩn dành cho học sinh lớp 1, học sinh có thể đọc trước kiến thức, tương tác làm bài tập trực tiếp tại sách ở đây trước khi xem video bài giảng và làm đề kiểm tra.</p>
        </div>

        <div class="class-filter-bar">
            <div class="label-orange-arrow">LỚP</div>
            <div class="class-tab active">Lớp 1</div>
            
        </div>

        <div class="books-wrapper">
            <h2 class="subject-title">TOÁN LỚP 1</h2>
            ...
            <div class="books-grid-layout">
                ...
                <div class="book-category-col">
                    ...
                    <div class="book-cards-row">
                        <div class="book-card">
                            <img src="anh_trang/toan1_tap 1.png" alt="Toán 1 Tập 1">
                            <div class="book-info">
                                <h4>Toán 1 - Tập 1</h4>
                                <a href="doc_sach.php?title=Toán 1 Tập 1" class="btn-read-now">Xem ngay</a>
                            </div>
                        </div>
                ...
                <div class="book-category-col">
                    ...
                    <div class="book-cards-row">
                        <div class="book-card">
                            <img src="anh_trang/toanbt1_tap1.png" alt="VBT Toán 1 Tập 1">
                            <div class="book-info">
                                <h4>Vở bài tập Toán 1 - Tập 1</h4>
                                <a href="#" class="btn-read-now">Xem ngay</a>
                            </div>
                        </div>
                        <div class="book-card">
                            <img src="anh_trang/toanbt1_tap2.png" alt="VBT Toán 1 Tập 2">
                            <div class="book-info">
                                <h4>Vở bài tập Toán 1 - Tập 2</h4>
                                <a href="#" class="btn-read-now">Xem ngay</a>
                            </div>
                        </div>
                    </div>
